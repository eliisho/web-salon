        ...
        <div class="col-12 col-md-8">
            <div class="card shadow-sm">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form action="/prosesEditService/<?= $data['id'] ?>" method="post">
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name" class="form-label fw-bold">Service</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="type_id" class="form-select" id="" value="<?= old('type_name', $data['type_name']) ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name" class="form-label fw-bold">Duration(Minute)</label>
                                            <input type="text" class="form-control form-control-lg shadow-sm" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg shadow-sm" 
                                            id="duration" name="price" value="<?= old('price', $data['price']) ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="name" class="form-label fw-bold">Description</label>
                                            <textarea name="description" class="form-control form-control-lg shadow-sm" rows="3"><?= old('description', $data['description']) ?></textarea>
                                        </div>
                                    </div>
                                <div class="col-md-12">
                                    <div class="form-group">
