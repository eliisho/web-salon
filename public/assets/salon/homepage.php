    ...
    <section id="banner">
        <nav class="navbar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="../../app/Views/user_form.php">Login</a></li>
        ...
        <div class="banner-text">
            ...
            <div class="banner-btn">
                <a href="#about"><span></span> Login for Reservation </a>
            </div>
        </div>
    </section>
        ...
        <div class="services-box">
            <div class="single-service">
                ...
                <div class="service-desc">
                    ...
                    <hr> <br>
                    <p><a href="salon/services/hair-styling.php">Click here<br>for further details</a></p>
                </div>
            </div>
            <div class="single-service">
                ...
                <div class="service-desc">
                    ...
                    <hr> <br>
                    <p><a href="salon/services/hair-coloring.php">Click here<br>for further details</a></p>
                </div>
            </div>
            <div class="single-service">
                ...
                <div class="service-desc">
                    ...
                    <hr> <br>
                    <p><a href="salon/services/spa.php">Click here<br>for further details</a></p>
                </div>
            </div>
            <div class="single-service">
                ...
                <div class="service-desc">
                    ...
                    <hr> <br>
                    <p><a href="salon/services/facial.php">Click here<br>for further details</a></p>
                </div>
            </div>
            <div class="single-service">
                ...
                <div class="service-desc">
                    ...
                    <hr> <br>
                    <p><a href="salon/services/manipedi.php">Click here<br>for further details</a></p>
                </div>
            </div>
            <div class="single-service">
                ...
                <div class="service-desc">
                    <h3>Make Up</h3><br>
                    <hr> <br>
                    <p><a href="salon/services/makeup.php">Click here<br>for further details</a></p>
                </div>
            </div>
            <div class="single-service">
                ...
                <div class="service-desc">
                    <h3>Nail Art</h3><br>
                    <hr> <br>
                    <p><a href="salon/services/nailart.php">Click here<br>for further details</a></p>
                </div>
            </div>
            <div class="single-service">
                ...
                <div class="service-desc">
                    ...
                    <hr> <br>
                    <p><a href="salon/services/waxing.php">Click here<br>for further details</a></p>
                </div>
            </div>
        </div>
        </section>
